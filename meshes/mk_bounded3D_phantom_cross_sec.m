function [ fmdl ] = mk_bounded3D_phantom_cross_sec( maxh )
%MK_BOUNDED3D_PHANTOM Make the mesh similar to our physical phantom
%   Phantom has 4 layers of 8 electrodes
%	Add the two targets into the mesh itself
%	(C) 2016/04/17 Sebastien Martin

debug = false;
if ~nargin; maxh=0.8; end
elec_per_layer = 8;
n_layers = 4;
elec_diam = 2;
thres_probe = 2;
...
% ref_top = '7.5'; ref_bot = '6.5';
% ref_top = '6.5'; ref_bot = '5.5';
...
shape_str = ['solid incyl = cylinder (0,0,',num2str(top_mid_cyl),'; 0,0,', ...
    ...
    'solid targ_obj1 = pl3 and pl4 and obj1; tlo targ_obj1 -maxh=',num2str(0.3),';\n ',...
    'solid targ_contour = pl6 and pl8 and contour and not targ_obj1; tlo targ_contour -maxh=',num2str(0.8),';\n ',...
